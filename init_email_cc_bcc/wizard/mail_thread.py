...
class MailThread(models.AbstractModel):
    ...
    def _notify_record_by_email(self, message, recipients_data, msg_vals=False,
                                ...
                                force_send=True, send_after_commit=True, email_cc=False, email_bcc=False,
                                **kwargs):
        ...
        for recipients_group_data in recipients_groups_data:
            ...
            for recipients_ids_chunk in split_every(recipients_max, recipients_ids):
                ...
                if (recipients_group_data.get('notification_is_customer', False)
                    or recipients_group_data.get('notification_group_name', '') == 'portal_customer'
                    or len(recipient_ids) == 1):
